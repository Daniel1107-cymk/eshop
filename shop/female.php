                    ...
                    <div class="col-lg-12">
                        <div class="bradcaump__inner text-center">
                            ...
                            <nav class="bradcaump-content">
                              ...
                              <span class="breadcrumb_item active">All Female Shoes</span>
                            </nav>
                        </div>
                    </div>
                </div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="section__title text-center">
							<h2 class="title__be--2">New <span class="color--theme">Sandals</span></h2>
				...
				<div class="furniture--4 border--round arrows_style owl-carousel owl-theme row mt--50">
					...
					<div class="product product__style--3">
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="product__thumb">
								<a class="first__img" href="single-product.html"><img src="http://localhost/ardy/images/books/1.jpg" alt="product image"></a>
							...
							<div class="product__content content--center">
								<h4><a href="single-product.html">robin ss</a></h4>
					...
					<div class="product product__style--3">
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="product__thumb">
								<a class="first__img" href="single-product.html"><img src="http://localhost/ardy/images/books/3.jpg" alt="product image"></a>
					...
					<div class="product product__style--3">
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="product__thumb">
								<a class="first__img" href="single-product.html"><img src="http://localhost/ardy/images/books/5.jpg" alt="product image"></a>
					...
					<div class="product product__style--3">
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="product__thumb">
								<a class="first__img" href="single-product.html"><img src="http://localhost/ardy/images/books/7.jpg" alt="product image"></a>
					...
					<div class="product product__style--3">
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="product__thumb">
								<a class="first__img" href="single-product.html"><img src="http://localhost/ardy/images/books/9.jpg" alt="product image"></a>
					...
					<div class="product product__style--3">
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="product__thumb">
								<a class="first__img" href="single-product.html"><img src="http://localhost/ardy/images/books/11.jpg" alt="product image"></a>
								<a class="second__img animation1" href="single-product.html"><img src="images/books/2.jpg" alt="product image"></a>
								<div class="hot__box">
