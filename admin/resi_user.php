            ...
            ?>
                <tbody>
                    <tr>
                        ...
                        <td><?php echo $d['tanggal_trans']; ?></td>
                        <td><?php echo $d['total_harga']; ?></td>
                        <td><?php echo $tr['nama_status_trans']; ?></td>
                        <td><?php echo $or['tanggal_kirim']; ?></td>
                        <td><?php echo $ki['nama_status_kirim']; ?></td>
                    </tr>
                </tbody>
                <?php 
                } //}
