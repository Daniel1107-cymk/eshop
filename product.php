        							...
        							<div class="product__info__main">
        								...
        								<div class="box-tocart d-flex">
        									...
        									<div class="addtocart__actions">
												...
												<a class="btn btn-danger" href="login_page.php">ADD TO CART</a>
        									</div>
        								</div>
        							</div>
        						</div>
								...
								<div class="productcategory__slide--2 arrows_style owl-carousel owl-theme">
									...
									<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
										<div class="product__thumb">
											<a class="first__img" href="product.php?id_stock=<?php echo $d['id_stock']; ?>&id_kategori=<?php echo $d['id_kategori']; ?>"><img src="images/produk/<?php echo $d['gambar'] ?>" alt="product image"></a>
										</div>
										<div class="product__content content--center">
											<h4><a href="product.php?id_stock=<?php echo $d['id_stock']; ?>&id_kategori=<?php echo $d['id_kategori']; ?>"></a></h4>
